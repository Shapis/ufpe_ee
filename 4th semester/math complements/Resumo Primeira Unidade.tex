...
% \ifthenelse{}{}{}\#7\undefined
% \draw[line width=1pt,#1](axis cs: #2, #3)--(axis cs: #4, #5) node[anchor=south west]{$#6$}
% \fi;}
}


\newcommand{\drawdashedline} [6] [gray] {\draw[line width=1pt,#1, dashed](axis cs: #2, #3)--(axis cs: #4, #5) node[anchor=south west]{$#6$};}
