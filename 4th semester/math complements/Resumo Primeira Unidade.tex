...
\newcommand{\drawvector} [9] [color=blue] {
...
\begin{adjustbox}{scale=0.9}
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \drawvector{0}{0}{1}{1}{Z}{true}{a}{b};
            \draw[line width=0pt,blue,-stealth](axis cs: 0, 0)--(axis cs: 1, 1)  node[anchor= south east, pos =0.5] {$\rho$};


            \draw [blue](axis cs: 0.3, 0) arc[start angle=0, end angle=45, radius=30]
