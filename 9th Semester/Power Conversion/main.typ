...
$ Delta V_o = 0.15% V_p = 0.15% 32.54V = 48.81 m V $

$ Delta V_o = V_p/(2 f R C) -> C = V_p/(2 f R Delta V_o) = V_p/(2 f 0.15% V_p) = 1/(0.18 R) = 1/(0.18 V_o) $
...
== Calcule os valores dos resistores conectados em série com os LEDs.
 ...
 $ R = (V_o - 2)/10 m A = Delta V_o = V p(1- sin(alpha)) -> \ -> 0.15% = 1-sin(alpha) -> \ -> sin(alpha) = 1 - 0.0015 -> alpha = arcsin(0.9985) = 86.86º $
