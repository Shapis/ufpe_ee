...
R1, R2, R3, R6, Vo1, Vo2, Vo3, Vcc, Vee, C, s, VC0 = smp.symbols(
    'R_1 R_2 R_3 R_6 V_o1 V_o2 V_o3 V_cc V_ee C s V_C0', real=True)

# Definindo as equacoes

eq1 = smp.Eq(((-Vo2)*s*C) + (-Vo1)/R3, 0)
eq2 = smp.Eq(((-Vo2)/R1) + ((-Vo1)/R2), 0)
eq3 = smp.Eq((Vo1/R3) + (Vo1/R2), 0)

smp.pprint(smp.solve([eq1, eq2, eq3], [Vo1, Vo2, R1]))
